...
export default function JumperCertificate() {
  return (
   <Modal show center size='lg'>
    <div className="" id="certificate" tabindex="-1" role="dialog" aria-labelledby="certificate" aria-hidden="true">
    ...
    <div className="modal-header border-0">
      ...
      <div className="text-center col-md-11 pr-5">
        <h5 style={{color:"var(--text-main)"}}>Certificate or diploma</h5>
      </div>
    </div>
        ...
        <div className="p-3 w-100">
          <div className="upload__btn-box d-flex flex-column align-items-center">
            ...
            <label className=" col-md-2 m-auto">
              <p className="m-0 p-0 text-center"><strong style={{cursor:"pointer"}}>Upload images</strong> </p>
