          ...
          <ul variant="tabs" className="mb-3">
            <li className="col-sm-12 col-md-3 text-center mb-2 m-0 p-0">
              <div eventKey="transit" className="p-2 w-100 d-flex justify-content-center align-items-center">
                <i class="bx bx-train mr-2" style={{ fontSize: '24px', color: 'grey' }} className="mr-2" />
                <span>Transit</span>
              </div>
            </li>
            <li className="col-sm-12 col-md-3 text-center m-0">
              <div eventKey="driving" className="p-2 w-100 d-flex justify-content-center align-items-center">
                <i class="bx bx-bus " style={{ fontSize: '24px', color: 'grey' }} className="mr-2" />
                <span>Driving</span>
              </div>
            </li> 
          </ul>
            ...
            <div eventKey="transit">
              <div className="d-flex align-items-center pb-3">
                <div className="col-md-11 d-flex p-0">
                  <i class='bx bx-location-plus mr-2' style={{ fontSize: '22px' }} className="mr-2" />
              ...
              <textarea class="form-control mb-3 border mt-5" id="exampleFormControlTextarea1" placeholder="Flughafenstraße 1-3, Hamburg, 22335" rows="3" style={{height:"100px", resize:"none"}}></textarea>
